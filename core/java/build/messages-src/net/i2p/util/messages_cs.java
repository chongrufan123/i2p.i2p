...
public class messages_cs extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[9] = new java.lang.String[] { "{0} podobn\u00e1 zpr\u00e1va vynech\u00e1na", "{0} podobn\u00e9 zpr\u00e1vy vynech\u00e1ny", "{0} podobn\u00fdch zpr\u00e1v vynech\u00e1no", "{0} podobn\u00fdch zpr\u00e1v vynech\u00e1no" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} rok", "{0} roky", "{0} let", "{0} let" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
