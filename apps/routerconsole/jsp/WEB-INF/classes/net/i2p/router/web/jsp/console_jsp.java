...
i2pcontextId);
      ...
      net.i2p.router.web.helpers.ResourceHelper contenthelper = null;
      contenthelper = (net.i2p.router.web.helpers.ResourceHelper) _jspx_page_context.getAttribute("contenthelper", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (contenthelper == null){
        contenthelper = new net.i2p.router.web.helpers.ResourceHelper();
        _jspx_page_context.setAttribute("contenthelper", contenthelper, javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      }
      ...
      out.write("</h2>\n </div>\n ");
      org.apache.jasper.runtime.JspRuntimeLibrary.introspecthelper(_jspx_page_context.findAttribute("contenthelper"), "page", "docs/readme.html", null, null, false);
      org.apache.jasper.runtime.JspRuntimeLibrary.introspecthelper(_jspx_page_context.findAttribute("contenthelper"), "maxLines", "300", null, null, false);
      org.apache.jasper.runtime.JspRuntimeLibrary.handleSetProperty(_jspx_page_context.findAttribute("contenthelper"), "contextId",
i2pcontextId);
      out.write(org.apache.jasper.runtime.JspRuntimeLibrary.toString((((net.i2p.router.web.helpers.ResourceHelper)_jspx_page_context.findAttribute("contenthelper")).getResource())));
