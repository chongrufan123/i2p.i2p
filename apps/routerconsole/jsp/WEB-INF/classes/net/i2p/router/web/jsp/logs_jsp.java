...
*/
 ...
 /* note to translators - both parameters are URLs */
      ...
      out.write("</td></tr>\n<tr><td><b>API version:</b></td><td>");
      out.print(net.i2p.CoreVersion.PUBLISHED_VERSION);
...
i2pcontextId);
   ...
   if (isX86) {
      ...
      out.print(net.i2p.util.SystemVersion.isService());
      out.write("</td></tr>\n");

   String rev = logsHelper.getRevision();
   if (rev.length() == 40) {

      out.write("<tr><td><b>Revision:</b></td><td>");
      out.print(rev);
      out.write("</td></tr>\n");

   }

      out.write("<tr><td><b>Built:</b></td><td>");
      out.write(org.apache.jasper.runtime.JspRuntimeLibrary.toString((((net.i2p.router.web.helpers.LogsHelper)_jspx_page_context.findAttribute("logsHelper")).getBuildDate())));
