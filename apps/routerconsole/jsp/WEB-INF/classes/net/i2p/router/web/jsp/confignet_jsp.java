...
i2pcontextId);
 ...
 navHelper.storeWriter(out); 
    ...
    try {
      ...
      out.write("&nbsp;\n  ");
      out.print(intl._t("If you specify the wrong IP address, or do not properly configure your NAT or firewall, your network performance will degrade substantially."));
      out.write("&nbsp;\n  ");
      out.print(intl._t("When in doubt, leave the settings at the defaults."));
      out.write("&nbsp;\n</p>\n  </td>\n </tr>\n <tr>\n  <th id=\"upnpconfig\">");
      out.print(intl._t("UPnP Configuration"));
      out.write("&nbsp;<a href=\"peers?tx=upnp\">[");
      ...
      out.write("</th>\n </tr>\n <tr>\n  <td>\n <b class=\"suboption\">");
      out.print(intl._t("Externally reachable IP address"));
