...
i2pcontextId);
   ...
   if (!intl.allowIFrame(theUserAgent)) {
      ...
      out.print(intl.title("Page Not Found"));
...
*/
      ...
      out.print(intl._t("Sorry! You appear to be requesting a nonexistent Router Console page or resource."));
      out.write("<hr>\n");
      out.print(intl._t("Error 404"));
      out.write(':');
      out.write(' ');
      out.print(ERROR_URI);
      out.write("&nbsp;");
      out.print(intl._t("not found"));
      out.write(".\n</div></body></html>\n");
