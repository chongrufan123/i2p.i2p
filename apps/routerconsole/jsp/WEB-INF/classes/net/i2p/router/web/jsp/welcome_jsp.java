...
i2pcontextId);
   ...
   if (!intl.allowIFrame(theUserAgent)) {
    ...
    for (int i = FIRST_PAGE; i <= LAST_PAGE; i++) {
      ...
      out.write("<span class=\"visitedProgression\">&#x2B24;</span>");

        } else if (i == ipg) {
            
      out.write("<span class=\"currentProgression\">&#x2B24;</span>");

        } else {
            
      out.write("<span class=\"unvisitedProgression\">&#x25EF;</span>");
...
i2pcontextId);
      ...
      out.write('\n');
      net.i2p.router.web.helpers.ConfigUIHelper uihelper2 = null;
      uihelper2 = (net.i2p.router.web.helpers.ConfigUIHelper) _jspx_page_context.getAttribute("uihelper2", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (uihelper2 == null){
        uihelper2 = new net.i2p.router.web.helpers.ConfigUIHelper();
        _jspx_page_context.setAttribute("uihelper2", uihelper2, javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      }
      out.write('\n');
      org.apache.jasper.runtime.JspRuntimeLibrary.handleSetProperty(_jspx_page_context.findAttribute("uihelper2"), "contextId",
i2pcontextId);
      out.write("\n<h3 id=\"wizardheading\" class=\"wizard\">");
      out.print(uihelper2._t("Select Theme"));
      out.write("</h3>\n<div class=\"wizardtext\">\n<p>\n");
      out.print(intl._t("Please select your preferred theme:"));
      out.write("\n<div id=\"wizlangsettings\" class=\"wizard\">\n");
      out.write(org.apache.jasper.runtime.JspRuntimeLibrary.toString((((net.i2p.router.web.helpers.ConfigUIHelper)_jspx_page_context.findAttribute("uihelper2")).getSettings())));
      out.write("\n</div>\n</p>\n</div>\n</div>\n");
...
i2pcontextId);
 ...
 int share = Math.round(wizhelper.getShareBandwidth() * 1.024f);
    if (share < 12) {
      ...
      out.write('\n');
      out.print(intl._t("This is normal behavior as part of the startup process, to make sure that your router is ready to help others with participating traffic."));
      out.write('\n');
