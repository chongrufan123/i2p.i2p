...
public final class edit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/editClient.jsi", Long.valueOf(1696759715566L));
    _jspx_dependants.put("/editServer.jsi", Long.valueOf(1696759715566L));
  }
...
if (__invalid) {
    ...
    if (editBean.isInitialized()) {
      ...
      out.write("<input type=\"text\" size=\"30\" name=\"proxyList\" title=\"");
      ...
      out.write("</td><td>\n                    <b>");
      out.print(intl._t("Outproxy Type"));
      out.write(":</b>\n                    <span class=\"multiOption\">\n                        <label><input value=\"socks\" type=\"radio\" name=\"outproxyType\" ");
      out.print((!isHTTPS ? " checked=\"checked\"" : ""));
      out.write(" class=\"tickbox\" />\n                        SOCKS</label>\n                    </span>\n                    <span class=\"multiOption\">\n                        <label><input value=\"connect\" type=\"radio\" name=\"outproxyType\" ");
      out.print((isHTTPS ? " checked=\"checked\"" : ""));
      out.write(" class=\"tickbox\" />\n                        HTTPS</label>\n                    </span>");
 ...
 // TODO: Convey to users: Where is the (1s) delay introduced? What is the difference between delay connect and delay open? 
      ...
      out.print(((has4 && !has0) ? " checked=\"checked\"" : edisabled));
      out.write(" class=\"tickbox\" />\n                    ECIES-X25519</label>\n                </span>\n                <span class=\"multiOption\" ");
      out.print(ehdisabled);
 ...
 boolean interactiveProfile = editBean.isInteractive(curTunnel);
      ...
      out.write("</th>\n        </tr><tr>\n            <th colspan=\"5\">\n                ");
      out.print(intl._t("Inbound connection limits"));
      out.write("</th>\n        </tr><tr>\n            <td></td>\n            <td><b>");
   ...
   String unlimited = " (0 = " + intl._t("unlimited") + ')';
      ...
      out.print(intl._t("Maximum number of web page requests per minute for a unique client before access to the server is blocked") + unlimited );
      out.write("\" value=\"");
      out.print(editBean.getLimitMinute(curTunnel));
      out.write("\" class=\"freetext\" />\n            </td><td>\n                <input type=\"text\" name=\"limitHour\" title=\"");
      out.print(intl._t("Maximum number of web page requests per hour for a unique client before access to the server is blocked") + unlimited );
      out.write("\" value=\"");
      out.print(editBean.getLimitHour(curTunnel));
      out.write("\" class=\"freetext\" />\n            </td><td>\n                <input type=\"text\" name=\"limitDay\" title=\"");
      out.print(intl._t("Maximum number of web page requests per day for a unique client before access to the server is blocked") + unlimited );
      out.write("\" value=\"");
      ...
      out.print(intl._t("Total number of web page requests per minute before access to the server is blocked") + unlimited );
      out.write("\" value=\"");
      out.print(editBean.getTotalMinute(curTunnel));
      out.write("\" class=\"freetext\" />\n            </td><td>\n                <input type=\"text\" name=\"totalHour\" title=\"");
      out.print(intl._t("Total number of web page requests per hour before access to the server is blocked") + unlimited );
      out.write("\" value=\"");
      out.print(editBean.getTotalHour(curTunnel));
      out.write("\" class=\"freetext\" />\n            </td><td>\n                <input type=\"text\" name=\"totalDay\" title=\"");
      out.print(intl._t("Total number of web page requests per day before access to the server is blocked") + unlimited );
      out.write("\" value=\"");
      out.print(editBean.getTotalDay(curTunnel));
      out.write("\" class=\"freetext\" />\n            </td><td class=\"blankColumn\"></td>\n        </tr><tr>\n            <th colspan=\"5\">");
      out.print(intl._t("Max concurrent connections"));
      out.write("</th>\n        </tr><tr>\n            <td></td><td>\n                <input type=\"text\" name=\"maxStreams\" title=\"");
      out.print(intl._t("Maximum number of simultaneous client connections") + unlimited );
      out.write("\" value=\"");
      ...
      out.print(intl._t("Maximum number of post requests permitted for a unique client for the configured time span") + unlimited );
      out.write("\" value=\"");
      ...
      out.print(intl._t("Total number of post requests permitted for the configured time span") + unlimited );
      out.write("\" value=\"");
      ...
      out.print(intl._t("Time span for the maximum number of post requests to be reached before a ban is triggered"));
      out.write("\" value=\"");
