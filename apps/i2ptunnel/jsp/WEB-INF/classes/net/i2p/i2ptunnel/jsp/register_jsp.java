...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  if (editBean.isInitialized()) {
    ...
    if (!"0".equals(curEncryptMode)) {
      ...
      out.write("<tr><td class=\"infohelp\">");
      out.print(intl._t("To enable registration verification, edit tunnel and set name (or website name) to a valid hostname ending in '.i2p'"));
      out.write("</td></tr>");

           } else {
               
      out.write("<tr><td class=\"infohelp\">");
      out.print(intl._t("To enable registration verification, edit tunnel and set name to a valid hostname ending in '.i2p'"));
      out.write("</td></tr>");
 ...
 he.write(out); 
      ...
      out.write("<tr><td class=\"infohelp\">");
      out.print(intl._t("This tunnel must be configured with the new hostname."));
      out.write("\n                  &nbsp;");
